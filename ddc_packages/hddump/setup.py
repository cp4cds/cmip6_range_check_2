...
META_PATH = os.path.join("hddump", "packageConfig.py")
KEYWORDS = ["CMIP6"]
CLASSIFIERS = [
...
INSTALL_REQUIRES = ["netCDF4","numpy","cftime"]
## numpy and cftime are required by netCDF4.
...
def find_meta(meta):
    ...
    """
    import hddump.packageConfig as pcfg
...
if __name__ == "__main__":
   if len(sys.argv) > 1 and sys.argv[1] == '-t':
      ...
      setup(
        ...
        data_files = [("", ["LICENSE"])],
        entry_points= {
        'console_scripts': ['hddump = hddump:command_line_entry'],
        },
    )
