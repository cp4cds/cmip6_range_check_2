"""
Django settings for test_april project.
...
# You need to
SECRET_KEY = '7609c96790d722ed56e8b64df15ede9028dba33c1fb888938b371ea2'
...
# * the url import in `test_april/urls.py`
INSTALLED_APPS = (
...
ROOT_URLCONF = 'test_april.urls'

WSGI_APPLICATION = 'test_april.wsgi.application'
